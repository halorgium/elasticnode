exports.Credential = function(accessKeyId, secretAccessKey) {
    this.accessKeyId = accessKeyId;
    this.secretAccessKey = secretAccessKey;
}

exports.AccountIdName = function(id, name) {
    this.accountid = id;
    this.displayname = name;
}

exports.Region = function(name, host) {
    this.name = name;
    this.host = host;
...
function Instance(resId, ownerId, groupList, instanceId, imageId, kernelId,
        ...
        amiLaunchIdx, instanceType, launchTime, placement, platform, tag, vpcId, subnetId) {
    this.resId = resId;
...
exports.AddressMapping = function (publicIp, instanceId, tag) {
